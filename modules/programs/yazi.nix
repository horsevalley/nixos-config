...
let
  yaziConfig = pkgs.writeText "keymap.toml" ''
    ...
    keymap = [
      ...
      { on = ["i"],       run = "plugin info",        desc = "Show info" },
      ...
      { on = [ "g", "C" ],       run = "cd ~/repos/github/CV/",          desc = "Go to the CV directory" },
      { on = [ "g", "d" ],       run = "cd ~/Documents",                 desc = "Go to the documents directory" },
      { on = [ "g", "D" ],       run = "cd ~/Downloads",                 desc = "Go to the downloads directory" },
      { on = [ "g", "h" ],       run = "cd ~",                           desc = "Go to the home directory" },
      { on = [ "g", "k" ],       run = "cd ~/Syncthing/pixel6a-kamera/", desc = "Go to the camera directory" },
      { on = [ "g", "m" ],       run = "cd ~/Music",                     desc = "Go to the music directory" },
      { on = [ "g", "M" ],       run = "cd ~/Videos/movies/",            desc = "Go to the movies directory" },
      { on = [ "g", "p" ],       run = "cd ~/Pictures",                  desc = "Go to the pictures directory" },
      { on = [ "g", "r" ],       run = "cd ~/recordings/",               desc = "Go to the recordings directory" },
      { on = [ "g", "t" ],       run = "cd ~/Videos/tv-shows/",          desc = "Go to the tv-shows directory" },
      { on = [ "g", "T" ],       run = "cd /tmp",                        desc = "Go to the temporary directory" },
      { on = [ "g", "w" ],       run = "cd ~/repos/github/wallpapers/",
